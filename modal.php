<div class="box-modal_close arcticmodal-close"><img src="/wp-content/themes/keramogranit/img/Close.png"></div>
<div class="artic-goods-container">

	<div class="arric-slider">
		<p><img id="bigetImg" src="/wp-content/themes/keramogranit/img/slide1.png" alt="Large image"></p>
		<div class="arric-slider-thumbs">
			<div class="arric-slider-btnLeft"><img src="/wp-content/themes/keramogranit/img/left.png" class="btn__arrow-artic"></div>
			<ul class="thumbs__item" id="thumbsSS">				   
				<li><a href="/wp-content/themes/keramogranit/img/slide1.png" title="Image 2"><img src="/wp-content/themes/keramogranit/img/slide1.png" width="80" height="80"></a></li>
				<li><a href="/wp-content/themes/keramogranit/img/slide2.png" title="Image 3"><img src="/wp-content/themes/keramogranit/img/slide2.png" width="80" height="80"></a></li>
				<li><a href="/wp-content/themes/keramogranit/img/slide3.png" title="Image 4"><img src="/wp-content/themes/keramogranit/img/slide3.png" width="80" height="80"></a></li>				   
			</ul>
			<div class="arric-slider-btnRight"><img src="/wp-content/themes/keramogranit/img/rigth.png" class="btn__arrow-artic"></div>
		</div>				  
	</div>
	...
	<div class="arctic__goods-list">
		...
		<div class="arctic__goods-info">
			<div class="arctic__goods-art"><p>Артикул: <span class="art__number">123445</span></p></div>
			<p class="arctic__goods-name"></p>
			...
			<button class="arctic__btn-heart d-flex" >
				<img src="/wp-content/themes/keramogranit/img/HeartInactive16px.png" class="arctic__heart">
